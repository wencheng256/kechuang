							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="alert alert-success">
										<ul>
											<li>请在这里写下该项目的最终评分</li>
											<li>如果分数为零则视为未对该项目打分</li>
										</ul>
									</div>
									<form class="form-horizontal" role="form" action="checkproject"
										method="post">
