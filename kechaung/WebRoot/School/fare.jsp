						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<Fare> fait=new Fare().selectAll();
											while(fait.hasNext()){
											Fare ft=fait.next();
										%>
										<tr>
											<td><%=ft.getPerstring()%></td>
											<td><%=ft.getProjectstring()%></td>
											<td><%=ft.getReason()%></td>
											<td><%=ft.getAmount()%></td>
								...
								<div class="widget-foot">
									<ul class="pagination pull-right">
										<li><a href="fare.jsp?page=<%=prev%>">上一页</a></li>
										<li><a href="fare.jsp?page=1">首页</a></li>
										<li><a>第<%=nowpage%>页 共 <%=maxpage%>页
										</a></li>
										<li><a href="fare.jsp?page=<%=maxpage%>">末页</a></li>
										<li><a href="fare.jsp?page=<%=next%>">下一页</a></li>
									</ul>
									<div class="clearfix"></div>
								</div>
							</div>
