						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
										Iterator<News> itjournal=usi.getNews().selectUser(0, 999);
										int bianhao=0;
										while(itjournal.hasNext()){
											bianhao++;
											News nt=itjournal.next();
									%>
										<tr>
											<td><%=bianhao %></td>
											<td><a href="newspage.jsp?id=<%=nt.getId()%>"><%=nt.getTitle() %></a></td>
											<td><%=nt.getDate() %></td>
											<td> <a href="updatenews.jsp?id=<%=nt.getId() %>"><button
														class="btn btn-xs btn-warning">
														<i class="icon-pencil"></i>
													</button></a> <a href="deletenews.action?id=<%=nt.getId() %>"><button
