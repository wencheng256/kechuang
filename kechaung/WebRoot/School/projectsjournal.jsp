					...
					<div class="col-md-12">
						...
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">项目日志（本页不可以改变日志的审阅状态）</div>
							...
							<div class="widget-content medias">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<ProjectJournal> itjou=new ProjectJournal().selectAllschool(start,pagesize,usi.getSchool());
										while(itjou.hasNext()){
												ProjectJournal jout=itjou.next();
										%>

										<tr>
											<td><%=jout.getProjnum()%></td>
											<td><%=jout.getProjname()%></td>
											<td><a href="journalpage.jsp?id=<%=jout.getId()%>"><%=jout.getTitle()%></a></td>
											<th><%=jout.getSortstring()%></th>
											<th><%=jout.getTime() %></th>
											<td>
												<div class="make-switch" data-on="warning" data-off="danger" >
													<input type="checkbox" name="is_public" value="1" <%if(jout.getStatus()!=1){ %> checked<%}%> onchange="change(<%=jout.getId()%>)">
												</div>
											</td>
											<%
												}
