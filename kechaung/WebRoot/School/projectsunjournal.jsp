					...
					<div class="col-md-12">
						...
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">尚未审核日志</div>
							...
							<div class="widget-content medias">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<ProjectJournal> itjou=new ProjectJournal().selectunAllschool(start,pagesize,usi.getSchool());
										while(itjou.hasNext()){
										...
										<tr>
											...
											<td><a href="unjournalpage.jsp?id=<%=jout.getId()%>"><%=jout.getTitle()%></a></td>
