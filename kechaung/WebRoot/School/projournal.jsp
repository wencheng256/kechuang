...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<div class="page-head">
				<h2 class="pull-left">
					<i class="icon-file-alt"></i> <%=proj.getName() %>  编号：<%=proj.getProj_permitid() %>
				</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><%=proj.getName() %>日志列表</div>
							...
							<div class="widget-content medias">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<ProjectJournal> itjou=proj.getJournal().selectProj(nowpage,pagesize);
										while(itjou.hasNext()){
