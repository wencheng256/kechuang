						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<Role> sit=new Role().selectAll();
																			int bianhao=0;
																			while(sit.hasNext()){
																			bianhao++;
																			Role st=sit.next();
										...
										<tr>
											<td><%=bianhao%></td>
											<td><%=st.getName()%></td>
											<td><a href="deleteschool.action?id=<%=st.getId()%>"><button
														class="btn btn-xs btn-danger">
														<i class="icon-remove"></i>
													</button></a>&nbsp&nbsp&nbsp<a href="roleaction.jsp?id=<%=st.getId()%>">角色配对表</a></td>
										</tr>
										<%
											}
										%>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="form profile">
										...
										<form class="form-horizontal" action="addrole.action"
											method="post">
											<!-- Email -->
											<div class="form-group">
												<label class="control-label col-lg-3" for="reason">角色名称</label>
												<div class="col-lg-6">
