						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<School> sit=new School().selectAll();
											int bianhao=0;
											while(sit.hasNext()){
											bianhao++;
											School st=sit.next();
							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="form profile">
										...
										<form class="form-horizontal" action="addschool.action"
											method="post">
											<!-- Email -->
											<div class="form-group">
												<label class="control-label col-lg-3" for="reason">学院名称</label>
												<div class="col-lg-6">
