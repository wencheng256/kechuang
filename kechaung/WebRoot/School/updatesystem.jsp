							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="form profile">
										...
										<form class="form-horizontal" action="updatesystem.action"
											method="post">
											<!-- Email -->
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" name="title"
														id="email1" value="<%=stuup.getTitle()%>">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" name="value"
														id="email1" value="<%=stuup.getValue()%>">
													<input type="hidden" class="form-control" name="id"
														id="email1" value="<%=stuup.getId()%>">
												</div>
											</div>
											<!-- Telephone -->
											<!-- Buttons -->
