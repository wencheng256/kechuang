						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<Fare> fait=proj.getFare().selectProj(proj.getId());
																										int bianhao=0;
																										while(fait.hasNext()){
																											bianhao++;
																											Fare ft=fait.next();
										...
										<tr>
											...
											<td><%=ft.getReason()%></td>
											<td><%=ft.getAmount()%></td>
											<td><a href="deletefare.action?id=<%=ft.getId()%>"><button
										...
										<tr>
											<td colspan="4"
												style="text-align:right;color:green; font-size:18px;">总计：<%=fareamount%>
												元
											</td>
										</tr>
									</tbody>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="widget wred">
							<div class="widget-head">
								<div class="pull-left">添加经费支出</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="form profile">
										...
										<form class="form-horizontal" action="addfare.action"
											method="post">
											<!-- Email -->
											<div class="form-group">
												<label class="control-label col-lg-3" for="reason">原因</label>
												<div class="col-lg-6">
											...
											<!-- Telephone -->
											<div class="form-group">
												<label class="control-label col-lg-3" for="amount">金额</label>
												<div class="col-lg-6">
