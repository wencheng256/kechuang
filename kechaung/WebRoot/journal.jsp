						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
										Iterator<ProjectJournal> itjournal=proj.getJournal().selectProj(start,pagesize);
										int bianhao=0;
										...
										<tr>
											...
											<td>
												<div class="make-switch" data-on="primary" data-off="info">
													<input type="checkbox" <%if(jt.getIs_public()==1){%>
														checked <%} %> onchange="change(<%=jt.getId() %>)">
												</div>
											</td>
											<td><%=jt.getTime() %></td>
											...
											<td><a href="updatejournal.jsp?id=<%=jt.getId() %>"><button
														class="btn btn-xs btn-success">
														<i class="icon-ok"></i>
													</button></a> <a href="updatejournal.jsp?id=<%=jt.getId() %>"><button
														class="btn btn-xs btn-warning">
														<i class="icon-pencil"></i>
													</button></a> <a href="deletejournal.action?id=<%=jt.getId() %>"><button
								...
								<div class="widget-foot">
									...
									<a href="addjournal.jsp"><button type="button"
											class=" pagination btn btn-info ">&nbsp &nbsp添加日志</button></a>
									<ul class="pagination pull-right">
										<li><a href="journal.jsp?page=<%=prev%>">上一页</a></li>
										<li><a href="journal.jsp?page=1">首页</a></li>
										<li><a>第<%=nowpage %>页 共 <%=maxpage %>页
										</a></li>
										<li><a href="journal.jsp?page=<%=maxpage%>">末页</a></li>
										<li><a href="journal.jsp?page=<%=next%>">下一页</a></li>
									</ul>
									...
									<div class="clearfix">
										...
										<div class="alert alert-success">
											<ul>
												<li>点击对号可以将文章从回收站中拿回日志列表</li>
												<li>任何日志在修改后都将被重新审核</li>
											</ul>
										</div>
									</div>
