...
<body>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<div class="padd"  style="height:370px; overflow:auto;">
									...
									<ul class="chats">
										<%
											Message message=oproj.getMessage();
								...
								<div class="widget-foot">
									...
									<form class="form-inline" action="addmessage.action"
										...
										<input type="hidden" name="receiver" value="<%=oproj.getId()%>">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tr>
										<td>指导老师</td>
										<td>
										<%Iterator<Director> itdir=oproj.getDirector().selectProject();
											while(itdir.hasNext()){
									...
									<tr>
										...
										<td>
											<%
												Iterator<Student> itstu1=oproj.getStudent().selectProject();
 ...
 %>
									...
									<tr>
										<td>项目水平</td>
										<td><%if(oproj.getImportant()==1){ %>重点立项<%}else{ %>一般项目<%} %></td>
									</tr>
									<tr>
										<td>项目分类</td>
										<td><%=oproj.getClassstring() %></td>
									</tr>
									<tr>
										<td>项目状态</td>
										<td><%=oproj.getStatusstring() %></td>
									</tr>
									<tr>
										<td>项目开始日期</td>
										<td><%=oproj.getApplytime() %></td>
									</tr>
									<tr>
										<td>项目编号</td>
										<td><%=oproj.getProj_permitid() %></td>
									</tr>
								</table>
								<a name="row"></a>
								<div class="widget-foot">
									<span
										style="padding:left:10px;textligin:center; font-size:16px;">项目进度：<%=oproj.getProgress()%>%
									</span>
									<div class="progress progress-striped active">
										<div class="progress-bar progress-bar-info" role="progressbar"
											aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
											style="width: <%=oproj.getProgress()%>%"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
											Iterator<ProjectJournal> itjournal=oproj.getJournal().selectProjpublic(start,pagesize);
																		int bianhao=0;
										...
										<tr>
											<td><%=bianhao%></td>
											<td><a href="otherjournalpage.jsp?id=<%=jt.getId()%>"><%=jt.getTitle()%></a></td>
											<td><%=jt.getTime()%></td>
				...
				<%
					Application appi=oproj.getApplication().selectId(oproj.getId());
				%>
				<%
				...
				<%
					FinalReport fri=oproj.getFinalreport().selectProject(); 
				%>
				<%
					if(fri.getIs_public()==1){
				%>
				<!-- 第二行 -->
				<div class="row">
					<div class="col-md-12">
