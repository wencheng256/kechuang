					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">学校新闻列表</div>
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<%
										Iterator<News> itnews=new News().selectSchool1(proj.getSchool());
										int bianhao=0;
									...
									%>
										<tr>
											<td><%=bianhao %></td>
											<td><a href="newscontent.jsp?id=<%=jt.getId()%>"><%=jt.getTitle() %></a></td>
											<td><%=jt.getDate() %></td>
											<td><%=jt.getUsername() %></td>
										<%} %>
									</tbody>
								</table>
								...
								<div class="widget-foot">
									<ul class="pagination pull-right">
										<li><a href="news.jsp?page=<%=prev%>">上一页</a></li>
										<li><a href="news.jsp?page=1">首页</a></li>
										<li><a>第<%=nowpage %>页 共 <%=maxpage %>页
										</a></li>
										<li><a href="news.jsp?page=<%=maxpage%>">末页</a></li>
										<li><a href="news.jsp?page=<%=next%>">下一页</a></li>
									</ul>
