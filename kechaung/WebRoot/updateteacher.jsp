							...
							<div class="widget-content">
								<div class="padd">
									...
									<div class="form profile">
										...
										<form class="form-horizontal" action="updateteacher.action"
											method="post">
											<!-- Email -->
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" name="phone"
														id="telephone" value="<%=stuup.getPhone()%>">
												</div>
											</div>
											<!-- Country -->
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" name="work"
														id="telephone" value="<%=stuup.getWork()%>">
												</div>
											</div>
											<input type="hidden" name="project" value="<%=proj.getId()%>">
											<input type="hidden" name="id" value="<%=stuup.getId()%>">
											<!-- Buttons -->
											<div class="form-group">
												<!-- Buttons -->
